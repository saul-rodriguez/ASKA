...
# This script was generated Mon Aug 26 08:38:48 2024 by:
#
...
#	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias.lvsfile -rcxdir \
#	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias -xy_coordinates c,r \
#	-type full -temperature 27.0 -tempdir \
#	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/rcx_temp \
...
#	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/extview.tmp \
...
#	-hcci_run_name bias -hcci_run_dir \
#	/home/saul/projects/ASKA/PvsLVS/bias/svdb -hcci_net_prop 5 \
...
#	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias.gds.map \
#	-add_explicit_vias
set -e
set -v
##=======================================================
...
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias.gds.map
...
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/saul/projects/ASKA/PvsLVS/bias/svdb
##HCCI_RUN_NAME=bias
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/rcx_temp
##TEMPERATURE=27.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/bias.gnx,/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/bias.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/saul/projects/ASKA/PvsLVS/bias/svdb/bias
...
agds2rcx -V -H satfile -r \
	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/bias.xcn \
	-split_float_exclude_layers ndiff,pdiff,nwtrm,pwitrm,dnwtrm,bulk \
	-crundir /home/saul/projects/ASKA/PvsLVS/bias/svdb -unit meters -df2 \
	-xgl -pl bias.ports -f bias.alm -lnn bias.lnn -pnet 5 -pinst 6 -pdev \
	7 bias.agf bias_pin_xy.spi
...
flattenLayers -m cont cont_p1trm_pdiff
flattenLayers -m vtpCON cont_p1trm_ndiff
flattenLayers -m vtpcm ntap
flattenLayers -m capm dntap
flattenLayers -m via3CON pwitap
flattenLayers -m via2CON ptap
flattenLayers -m via1 nemi_06
flattenLayers -m cont_m1trm_p1trm mosvcm
flattenLayers -m cont_m1trm_pdiff nem_orig
flattenLayers -m cont_m1trm_ndiff pem_orig
...
GNDA
ENDCAT
sch2lay -a -r /home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/bias.gnx -rd /home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/bias.gdx sch_cap_ground lay_cap_ground
...
reconnect -cgnd ${CAP_GROUND} -float floatlvsnetsfile -tf nem,pem -qf qpvmc \
	-rf rpp1k1_0s,rpp1k1_0n -cf cmim -df p_0dnw,p_0ddnw,p_0dipwmv,p_0dnwm \
	-gf BOX -probe \
...
connect -V -relocate NET np_rndiff:np_rndiff.conn np_rpdiff:np_rpdiff.conn \
	...
	rvtpCON nem_mgvia pem_mgvia rpp1k1_0s_rvia rpp1k1_0n_rvia \
	cmim_m4trm_cvia nemi_06_p1trm_gdvia mosvcm_p1trm_gdvia - dntap,1,5 \
	ntap,1,3 ptap,2,6 pwitap,2,4 -
...
rex -V -m -pd -I'#' -tech \
	...
	cmim_m4trm_cvia:rpp1k1_0s_rvia,rpp1k1_0n_rvia:nemi_06_p1trm_gdvia,mosvcm_p1trm_gdvia \
	...
	cmim_m4trm_cvia,5,z nemi_06_p1trm_gdvia,1,z mosvcm_p1trm_gdvia,1,z - \
...
xreduce -V -mergecap -n NET -tech \
	...
	np_rmttrm.res,np_rm4trm.res,np_rm3trm.res,np_rm2trm.res,np_rm1trm.res,np_rp1trm.res,rwires.res,bwires.res,mwires.res,qwires.res,cwires.res,dwires.res,rcont_m1trm_ndiff.res,rcont_m1trm_p1trm.res,rcont_m1trm_pdiff.res,rcont_p1trm_ndiff.res,rcont_p1trm_pdiff.res,rvia1.res,rvia2CON.res,rvia3CON.res,rvtpCON.res,rvtpcm.res \
	-minC 5e-14 -minCper 1 -cap capfile L1T0 L2T0 L3T0 L4T0 nem.transnr \
	pem.transnr qpvmc.qtransr rpp1k1_0s.resr rpp1k1_0n.resr cmim.cpaxr \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0,L4T0 -dxref \
	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/bias.gdx -nxref \
	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/bias.gnx -addprefix \
	-bp BOX.transn -sc caps2dversion -mx capfile \
	...
	-raMu lvsres.mod,rpp1k1_0s.net rpp1k1_0s.resr -raMu \
	...
	p_0dnwm.dpaxr -q lvsbjt.mod1,qpvmc.net qpvmc.qtransr - NET - \
	/home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/extview.tmp
...
mosvcm mosvcm
ENDCAT
cat /home/saul/projects/ASKA/PvsLVS/bias/svdb/bias/hccisavefile >> \
	_save_layers
