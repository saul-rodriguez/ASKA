...
# This script was generated Mon Aug 26 08:09:41 2024 by:
#
...
#	-hcci_run_name por2 -hcci_run_dir \
...
flattenLayers -m npdtap npdtap_ndiff_npdct
flattenLayers -m via2CON npdct
flattenLayers -m via1 npdtap_pdiff_npdct
flattenLayers -m cont_m1trm_p1trm ntap
flattenLayers -m cont_m1trm_pdiff ptap
flattenLayers -m cont_m1trm_ndiff mosvcm
...
GNDA
ENDCAT
sch2lay -a -r /home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/por2.gnx -rd /home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/por2.gdx sch_cap_ground lay_cap_ground
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0 -dxref \
	...
	BOXr -bl BOXL BOXSUB -raMu lvsres.mod,rpp1k1_0s.net rpp1k1_0s.resr \
	-ta lvsmos.mod,nem.net nem.transnr -ta lvsmos.mod,pem.net pem.transnr \
	-dM lvsdio.mod1,p_0dnw.net p_0dnw.dpaxr -dM lvsdio.mod2,p_0dnwm.net \
	p_0dnwm.dpaxr - NET - \
	/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/extview.tmp
