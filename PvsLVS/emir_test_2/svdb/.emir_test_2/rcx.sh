...
# This script was generated Wed Jul 17 11:20:58 2024 by:
#
...
#	/home/saul/projects/ASKA/PvsLVS/emir_test_2/svdb/emir_test_2/extview.tmp \
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/saul/projects/ASKA/PvsLVS/emir_test_2/svdb/emir_test_2/extview.tmp
...
agds2rcx -V -H satfile -r \
	...
	/home/saul/projects/ASKA/PvsLVS/emir_test_2/svdb -unit meters -df2 \
	-xgl -pl emir_test_2.ports -f emir_test_2.alm -lnn emir_test_2.lnn \
	-pnet 5 -pinst 6 -pdev 7 emir_test_2.agf emir_test_2_pin_xy.spi
...
xreduce -V -mergecap -n NET -tech \
	...
	rcont_m1trm_p1trm.res -rP np_rp1trm.res,np_rm1trm.res,rwires.res \
	-minC 1e-17 -minCper 0.1 -cap capfile L1T0 rpp1k1_02.resr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -dxref \
	/home/saul/projects/ASKA/PvsLVS/emir_test_2/svdb/emir_test_2/emir_test_2.gdx \
	-nxref \
	/home/saul/projects/ASKA/PvsLVS/emir_test_2/svdb/emir_test_2/emir_test_2.gnx \
	...
	rcont_m1trm_p1trm.res,Rrcont_m1trm_p1trm.dev2 -rPm rwires.mod \
...
bulk bulk
ENDCAT
cat /home/saul/projects/ASKA/PvsLVS/emir_test_2/svdb/emir_test_2/hccisavefile \
	>> _save_layers
