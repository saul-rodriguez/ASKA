...
# This script was generated Mon Aug 26 08:48:01 2024 by:
#
...
flattenLayers -m vtpCON npdct
flattenLayers -m vtpcm npdtap_pdiff_npdct
flattenLayers -m capm ntap
flattenLayers -m via3CON dntap
flattenLayers -m via2CON pwitap
flattenLayers -m via1 ptap
flattenLayers -m cont_m1trm_p1trm nedia2_0d
flattenLayers -m cont_m1trm_pdiff nemi_06
