...
# This script was generated Thu Jun 20 06:00:04 2024 by:
#
...
#	-hierarchy_delimiter / -hcci_run_name constant_gm -hcci_run_dir \
...
xreduce -V -mergecap -n NET -tech \
	...
	rvia2CON.res,rvia1.res,rcont_m1trm_p1trm.res,rcont_m1trm_pdiff.res,rcont_m1trm_ndiff.res,rcont_p1trm_pdiff.res,rcont_p1trm_ndiff.res \
	-rP \
	np_rp1trm.res,np_rm1trm.res,np_rm2trm.res,np_rm3trm.res,rwires.res,bwires.res,mwires.res,dwires.res \
