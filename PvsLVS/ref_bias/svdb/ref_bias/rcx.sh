...
# This script was generated Mon Jun 24 11:07:25 2024 by:
#
...
#	/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias.lvsfile \
#	-rcxdir /home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias \
#	-xy_coordinates c,r -type full -temperature 27.0 -tempdir \
#	/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/rcx_temp \
...
#	-output \
#	/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/extview.tmp \
...
#	-hierarchy_delimiter / -hcci_run_name ref_bias -hcci_run_dir \
#	/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb -hcci_net_prop 5 \
...
#	/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias.gds.map
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias.gds.map
...
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb
##HCCI_RUN_NAME=ref_bias
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/extview.tmp
...
##TEMPDIR=/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/rcx_temp
##TEMPERATURE=27.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/ref_bias.gnx,/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/ref_bias.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias
...
agds2rcx -V -H satfile -r \
	/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/ref_bias.xcn \
	-split_float_exclude_layers ndiff,pdiff,nwtrm,pwitrm,dnwtrm,bulk \
	-crundir /home/saul/projects/ASKA/PvsLVS/ref_bias/svdb -unit meters \
	-df2 -xgl -pl ref_bias.ports -f ref_bias.alm -lnn ref_bias.lnn -pnet \
	5 -pinst 6 -pdev 7 ref_bias.agf ref_bias_pin_xy.spi
...
flattenLayers -m cont via3CON cont_m1trm_pdiff ntap nemi_06
flattenLayers -m vtpCON via2CON cont_m1trm_ndiff dntap mosvcm
flattenLayers -m vtpcm via1 cont_p1trm_pdiff pwitap
flattenLayers -m capm cont_m1trm_p1trm cont_p1trm_ndiff ptap
...
reconnect -cgnd ${CAP_GROUND} -float floatlvsnetsfile -tf nem,pem -rf \
	rpp1k1_0s -cf cmim -df p_0dnw,p_0ddnw,p_0dipwmv,p_0dnwm -gf BOX \
	-probe \
...
connect -V -relocate NET np_rndiff:np_rndiff.conn np_rpdiff:np_rpdiff.conn \
	...
	rvtpCON nem_mgvia pem_mgvia rpp1k1_0s_rvia cmim_m4trm_cvia \
	nemi_06_p1trm_gdvia mosvcm_p1trm_gdvia - dntap,1,5 ntap,1,3 ptap,2,6 \
	pwitap,2,4 -
...
rex -V -m -pd -I'#' -tech \
	...
	cmim_m4trm_cvia:rpp1k1_0s_rvia:nemi_06_p1trm_gdvia,mosvcm_p1trm_gdvia \
	...
	nem_mgvia,1,z pem_mgvia,1,z rpp1k1_0s_rvia,1,z cmim_m4trm_cvia,5,z \
	nemi_06_p1trm_gdvia,1,z mosvcm_p1trm_gdvia,1,z - L1T0,2,I L2T0,3,I \
	L3T0,4,I
...
xreduce -V -mergecap -n NET -tech \
	...
	pem.transnr rpp1k1_0s.resr cmim.cpaxr p_0dnw.dpaxr p_0ddnw.dpaxr \
	p_0dipwmv.dpaxr p_0dnwm.dpaxr BOXr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0 -dxref \
	/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/ref_bias.gdx \
	-nxref \
	/home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/ref_bias.gnx \
	...
	cwires.mod cwires.res,cwires.dev2 -rPmw dwires.mod \
	dwires.res,dwires.dev2 -rPmw bwires.mod bwires.res,bwires.dev2 -b \
...
mosvcm mosvcm
ENDCAT
cat /home/saul/projects/ASKA/PvsLVS/ref_bias/svdb/ref_bias/hccisavefile >> \
	_save_layers
