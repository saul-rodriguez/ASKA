...
# This script was generated Wed Jun 26 14:50:01 2024 by:
#
...
#	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2.lvsfile \
#	-rcxdir \
#	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2 \
#	-xy_coordinates c,r -type full -temperature 27.0 -tempdir \
#	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/rcx_temp \
...
#	-output \
#	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/extview.tmp \
...
#	-hierarchy_delimiter / -hcci_run_name dac6b_amp_n2 -hcci_run_dir \
#	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb -hcci_net_prop 5 \
...
#	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2.gds.map
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2.gds.map
...
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb
##HCCI_RUN_NAME=dac6b_amp_n2
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/rcx_temp
##TEMPERATURE=27.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/dac6b_amp_n2.gnx,/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/dac6b_amp_n2.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2
...
agds2rcx -V -H satfile -r \
	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/dac6b_amp_n2.xcn \
	-split_float_exclude_layers ndiff,pdiff,nwtrm,pwitrm,dnwtrm,bulk \
	-crundir /home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb -unit \
	meters -df2 -xgl -pl dac6b_amp_n2.ports -f dac6b_amp_n2.alm -lnn \
	dac6b_amp_n2.lnn -pnet 5 -pinst 6 -pdev 7 dac6b_amp_n2.agf \
	dac6b_amp_n2_pin_xy.spi
...
flattenLayers -m cont cont_m1trm_p1trm cont_p1trm_ndiff ptap
flattenLayers -m via3CON cont_m1trm_pdiff ntap nemi_06
flattenLayers -m via2CON cont_m1trm_ndiff dntap
flattenLayers -m via1 cont_p1trm_pdiff pwitap
...
reconnect -cgnd ${CAP_GROUND} -float floatlvsnetsfile -tf nem,pem -rf \
	rpp1k1_0s -df p_0dnw,p_0ddnw,p_0dipwmv,p_0dnwm -gf BOX -probe \
...
geom nem,pem,nemi_06 - qrcgate,1,i,1
...
connect -V -relocate NET np_rndiff:np_rndiff.conn np_rpdiff:np_rpdiff.conn \
	...
	np_rdnwtrm:np_rdnwtrm.conn np_rbulk:np_rbulk.conn rcont_m1trm_p1trm \
	rvia1 rvia2CON rvia3CON nem_mgvia pem_mgvia rpp1k1_0s_rvia \
	nemi_06_p1trm_gdvia - dntap,1,5 ntap,1,3 ptap,2,6 pwitap,2,4 -
...
epick -V -reo -e rcont_m1trm_ndiff -e rcont_m1trm_pdiff -e rcont_p1trm_ndiff \
	-e rcont_p1trm_pdiff np_rpwitrm.conn tmp_pwitrm
...
epick -V -reo -e rcont_m1trm_ndiff -e rcont_m1trm_pdiff -e rcont_p1trm_ndiff \
	-e rcont_p1trm_pdiff np_rdnwtrm.conn tmp_dnwtrm
...
rex -V -m -pd -I'#' -tech \
	...
	rpp1k1_0s_rvia:nemi_06_p1trm_gdvia -rP res.mod np_rp1trm::POLY1_cut \
	np_rm1trm::MET1_cut np_rm2trm::MET2_cut np_rm3trm::MET3_cut \
	np_rm4trm::MET4_cut - rcont_m1trm_ndiff,2,t rcont_m1trm_p1trm,1,2,t \
	rcont_m1trm_pdiff,2,t rcont_p1trm_ndiff,1,t rcont_p1trm_pdiff,1,t \
	rvia1,2,3,t rvia2CON,3,4,t rvia3CON,4,5,t nem_mgvia,1,z pem_mgvia,1,z \
	rpp1k1_0s_rvia,1,z nemi_06_p1trm_gdvia,1,z - L1T0,2,I L2T0,3,I \
	L3T0,4,I
...
reconnect -V -se2 bwires.res -n NET -b BOX:BOXr nemi_06 \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R METTPL -b \
	MET3,MET2,MET1,POLY1,active,sub -Maxw 45 -p \
...
emerge -V nem pem nemi_06 GateLayers
...
pax16 -V -lee_off -delete_unused_files rm_files_in_pax16 -gnd ${CAP_GROUND} \
	...
	MET3:MET3_cut MET4:MET4_cut METTP METTPL GateLayers - \
	/home/saul/pkg/xfab/XKIT/xh018/cadence/v9_0/QRC_pvs/v9_0_1/XH018_1143/QRC-Typ/qrcTechFile \
	- - NET - capfile
...
xreduce -V -mergecap -n NET -tech \
	/home/saul/pkg/xfab/XKIT/xh018/cadence/v9_0/QRC_pvs/v9_0_1/XH018_1143/QRC-Typ \
	-d1 -e \
	METTPL,METTP,MET4,MET3,MET2,MET1,POLY1,active,sub,np_rndiff,np_rpdiff,np_rnwtrm,np_rpwitrm,np_rdnwtrm,np_rbulk,rcont_m1trm_p1trm,rvia1,rvia2CON,rvia3CON \
	-sr -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 -rPvia \
	rvia3CON.res,rvia2CON.res,rvia1.res,rcont_m1trm_p1trm.res,rcont_m1trm_pdiff.res,rcont_m1trm_ndiff.res,rcont_p1trm_pdiff.res,rcont_p1trm_ndiff.res \
	-rP \
	np_rp1trm.res,np_rm1trm.res,np_rm2trm.res,np_rm3trm.res,np_rm4trm.res,rwires.res,bwires.res,mwires.res,dwires.res \
	-minC 1e-17 -minCper 0.1 -cap capfile L1T0 L2T0 L3T0 nem.transnr \
	pem.transnr rpp1k1_0s.resr p_0dnw.dpaxr p_0ddnw.dpaxr p_0dipwmv.dpaxr \
	p_0dnwm.dpaxr BOXr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0 -dxref \
	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/dac6b_amp_n2.gdx \
	-nxref \
	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/dac6b_amp_n2.gnx \
	-addprefix -bp BOX.transn -sc caps2dversion -mx capfile \
	METTPL,METTP,MET4,MET3,MET2,MET1,POLY1,active,sub -rPmw res.mod \
	np_rm4trm.res,Rnp_rm4trm.dev2 np_rm3trm.res,Rnp_rm3trm.dev2 \
	np_rm2trm.res,Rnp_rm2trm.dev2 np_rm1trm.res,Rnp_rm1trm.dev2 \
	np_rp1trm.res,Rnp_rp1trm.dev2 rvia3CON.res,Rrvia3CON.dev2 \
	rvia2CON.res,Rrvia2CON.dev2 rvia1.res,Rrvia1.dev2 \
	...
	rcont_p1trm_ndiff.res,Rrcont_p1trm_ndiff.dev2 -rPmw mwires.mod \
	mwires.res,mwires.dev2 -rPmw rwires.mod rwires.res,rwires.dev2 -rPmw \
	dwires.mod dwires.res,dwires.dev2 -rPmw bwires.mod \
	bwires.res,bwires.dev2 -b BOXr -bl BOXL BOXSUB -raMu \
	lvsres.mod,rpp1k1_0s.net rpp1k1_0s.resr -ta lvsmos.mod,nem.net \
	nem.transnr -ta lvsmos.mod,pem.net pem.transnr -dM \
	lvsdio.mod1,p_0dnw.net p_0dnw.dpaxr -dM lvsdio.mod2,p_0ddnw.net \
	p_0ddnw.dpaxr -dM lvsdio.mod3,p_0dipwmv.net p_0dipwmv.dpaxr -dM \
	lvsdio.mod4,p_0dnwm.net p_0dnwm.dpaxr - NET - \
	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/extview.tmp
...
ENDCAT
cat \
	/home/saul/projects/ASKA/PvsLVS/dac6b_amp_n2/svdb/dac6b_amp_n2/hccisavefile \
	>> _save_layers
