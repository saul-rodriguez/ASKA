...
# This script was generated Tue Jun 25 15:49:00 2024 by:
#
...
#	-hierarchy_delimiter / -hcci_run_name bandgap_su -hcci_run_dir \
...
flattenLayers -m cont via3CON cont_m1trm_pdiff ntap
flattenLayers -m vtpCON via2CON cont_m1trm_ndiff ptap
flattenLayers -m vtpcm via1 cont_p1trm_pdiff
flattenLayers -m capm cont_m1trm_p1trm cont_p1trm_ndiff
...
xreduce -V -mergecap -n NET -tech \
	...
	-rP \
	np_rp1trm.res,np_rm1trm.res,np_rm2trm.res,np_rm3trm.res,np_rm4trm.res,np_rmttrm.res,rwires.res,mwires.res,qwires.res,cwires.res,dwires.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0 -dxref \
	...
	mwires.res,mwires.dev2 -rPmw qwires.mod qwires.res,qwires.dev2 -rPmw \
	rwires.mod rwires.res,rwires.dev2 -rPmw cwires.mod \
	cwires.res,cwires.dev2 -rPmw dwires.mod dwires.res,dwires.dev2 -raMu \
