...
# This script was generated Fri Aug 23 11:28:18 2024 by:
#
...
flattenLayers -m cont cont_p1trm_pdiff pem_orig
flattenLayers -m npdtap cont_p1trm_ndiff
flattenLayers -m via3CON npdtap_ndiff_npdct
...
flattenLayers -m cont_m1trm_ndiff nem_orig
...
connect -V -relocate NET np_rndiff:np_rndiff.conn np_rpdiff:np_rpdiff.conn \
	...
	nem_mgvia pem_mgvia - npdtap_ndiff_npdct,1,5 npdtap_pdiff_npdct,2,5 \
	ntap,1,3 ptap,2,4 -
...
rex -V -m -pd -I'#' -tech \
	...
	res.mod np_rp1trm::POLY1_cut np_rm1trm::MET1_cut np_rm2trm::MET2_cut \
	np_rm3trm::MET3_cut np_rm4trm::MET4_cut - rcont_m1trm_ndiff,2,T \
	...
	nem_mgvia,1,z pem_mgvia,1,z - L1T0,2,I
...
xreduce -V -mergecap -n NET -tech \
	/pkg/xfab2/XKIT/xh018/cadence/v9_0/QRC_pvs/v9_0_1/XH018_1143/QRC-Typ \
	-d1 -e \
	METTPL,METTP,MET4,MET3,MET2,MET1,POLY1,active,sub,np_rndiff,np_rpdiff,np_rnwtrm,np_rbulk,rcont_m1trm_p1trm,rvia1,rvia2CON,rvia3CON \
	-sr -g ${CAP_GROUND},1.0 -minR 0.1 -rP \
	np_rm4trm.res,np_rm3trm.res,np_rm2trm.res,np_rm1trm.res,np_rp1trm.res,mwires.res,dwires.res,rcont_m1trm_ndiff.res,rcont_m1trm_p1trm.res,rcont_m1trm_pdiff.res,rcont_p1trm_ndiff.res,rcont_p1trm_pdiff.res,rvia1.res,rvia2CON.res,rvia3CON.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -dxref \
	...
	rvia2CON.res,Rrvia2CON.dev2 rvia3CON.res,Rrvia3CON.dev2 -rPmwl \
	mwires.mod mwires.res,mwires.dev2 -rPmwl dwires.mod \
	dwires.res,dwires.dev2 -ta lvsmos.mod,nem.net nem.transnr -ta \
	lvsmos.mod,pem.net pem.transnr -dM lvsdio.mod1,p_0dnwm.net \
	p_0dnwm.dpaxr - NET - \
	/home/saul/projects/ASKA/PvsLVS/del_test/svdb/del_test/extview.tmp
