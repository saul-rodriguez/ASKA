...
# This script was generated Wed Aug 14 02:07:57 2024 by:
#
...
#	/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm.lvsfile \
#	-rcxdir /home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm \
#	-xy_coordinates c,r -type full -temperature 27.0 -tempdir \
#	/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/rcx_temp \
...
#	/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/extview.tmp \
...
#	-hcci_run_name constant_gm -hcci_run_dir \
#	/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb -hcci_net_prop 5 \
...
#	/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm.gds.map \
#	-add_explicit_vias
set -e
set -v
##=======================================================
...
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm.gds.map
...
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb
##HCCI_RUN_NAME=constant_gm
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/extview.tmp
...
##TEMPDIR=/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/rcx_temp
##TEMPERATURE=27.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/constant_gm.gnx,/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/constant_gm.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm
...
agds2rcx -V -H satfile -r \
	/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/constant_gm.xcn \
	-split_float_exclude_layers ndiff,pdiff,nwtrm,pwitrm,dnwtrm,bulk \
	-crundir /home/saul/projects/ASKA/PvsLVS/constant_gm/svdb -unit \
	meters -df2 -xgl -pl constant_gm.ports -f constant_gm.alm -lnn \
	constant_gm.lnn -pnet 5 -pinst 6 -pdev 7 constant_gm.agf \
	constant_gm_pin_xy.spi
...
flattenLayers -m cont cont_m1trm_pdiff ntap nemi_06
flattenLayers -m via2CON cont_m1trm_ndiff dntap
flattenLayers -m via1 cont_p1trm_pdiff pwitap
flattenLayers -m cont_m1trm_p1trm cont_p1trm_ndiff ptap
...
GNDA
ENDCAT
sch2lay -a -r /home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/constant_gm.gnx -rd /home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/constant_gm.gdx sch_cap_ground lay_cap_ground
...
reconnect -cgnd ${CAP_GROUND} -float floatlvsnetsfile -tf nem,pem -rf \
	rpp1k1_0n -df p_0dnw,p_0ddnw,p_0dipwmv,p_0dnwm -gf BOX -probe \
...
connect nem,nemi_06,nemi_06,nemi_06,nemi_06,extenddiff:dev_np_rndiff -  - 
...
connect -V -relocate NET np_rndiff:np_rndiff.conn np_rpdiff:np_rpdiff.conn \
	...
	rvia1 rvia2CON nem_mgvia pem_mgvia rpp1k1_0n_rvia nemi_06_p1trm_gdvia \
	- dntap,1,5 ntap,1,3 ptap,2,6 pwitap,2,4 -
...
rex -V -m -pd -I'#' -tech \
	...
	rpp1k1_0n_rvia:nemi_06_p1trm_gdvia -rP res.mod np_rp1trm::POLY1_cut \
	...
	rvia2CON,3,4,T nem_mgvia,1,z pem_mgvia,1,z rpp1k1_0n_rvia,1,z \
	nemi_06_p1trm_gdvia,1,z - L1T0,2,I L2T0,3,I L3T0,4,I
...
sw3d -V -cgnd ${CAP_GROUND} -sub 2 -b MET2,MET1,POLY1,active,sub -t \
	METTP,METTPL -p MET3:MET3_cut,MET4 - MET3_MET4.sw3d
...
pax16 -V -lee_off -delete_unused_files rm_files_in_pax16 -gnd ${CAP_GROUND} \
	...
	MET3:MET3_cut MET4 METTP METTPL GateLayers - \
	/home/saul/pkg/xfab/XKIT/xh018/cadence/v9_0/QRC_pvs/v9_0_1/XH018_1143/QRC-Typ/qrcTechFile \
	- - NET - capfile
...
xreduce -V -mergecap -n NET -tech \
	/home/saul/pkg/xfab/XKIT/xh018/cadence/v9_0/QRC_pvs/v9_0_1/XH018_1143/QRC-Typ \
	-d1 -e \
	METTPL,METTP,MET4,MET3,MET2,MET1,POLY1,active,sub,np_rndiff,np_rpdiff,np_rnwtrm,np_rpwitrm,np_rdnwtrm,np_rbulk,rcont_m1trm_p1trm,rvia1,rvia2CON \
	-sr -g ${CAP_GROUND},1.0 -minR 1 -rP \
	np_rm3trm.res,np_rm2trm.res,np_rm1trm.res,np_rp1trm.res,rwires.res,bwires.res,mwires.res,dwires.res,rcont_m1trm_ndiff.res,rcont_m1trm_p1trm.res,rcont_m1trm_pdiff.res,rcont_p1trm_ndiff.res,rcont_p1trm_pdiff.res,rvia1.res,rvia2CON.res \
	-minC 5e-14 -minCper 1 -cap capfile L1T0 L2T0 L3T0 nem.transnr \
	pem.transnr rpp1k1_0n.resr p_0dnw.dpaxr p_0ddnw.dpaxr p_0dipwmv.dpaxr \
	p_0dnwm.dpaxr BOXr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0 -dxref \
	/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/constant_gm.gdx \
	-nxref \
	/home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/constant_gm.gnx \
	...
	rvia2CON.res,Rrvia2CON.dev2 -rPmwl mwires.mod mwires.res,mwires.dev2 \
	-rPmwl rwires.mod rwires.res,rwires.dev2 -rPmwl dwires.mod \
	dwires.res,dwires.dev2 -rPmwl bwires.mod bwires.res,bwires.dev2 -b \
	BOXr -bl BOXL BOXSUB -raMu lvsres.mod,rpp1k1_0n.net rpp1k1_0n.resr \
	-ta lvsmos.mod,nem.net nem.transnr -ta lvsmos.mod,pem.net pem.transnr \
	-dM lvsdio.mod1,p_0dnw.net p_0dnw.dpaxr -dM lvsdio.mod2,p_0ddnw.net \
...
nemi_06 nemi_06
ENDCAT
cat /home/saul/projects/ASKA/PvsLVS/constant_gm/svdb/constant_gm/hccisavefile \
	>> _save_layers
