...
# This script was generated Fri Jun 21 17:10:34 2024 by:
#
...
#	/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2.lvsfile -rcxdir \
#	/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2 -xy_coordinates c,r \
#	-type full -temperature 27.0 -tempdir \
#	/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/rcx_temp \
...
#	-output /home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/extview.tmp \
...
#	-hierarchy_delimiter / -hcci_run_name por2 -hcci_run_dir \
#	/home/saul/projects/ASKA/PvsLVS/por2/svdb -hcci_net_prop 5 \
...
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2.gds.map
...
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/saul/projects/ASKA/PvsLVS/por2/svdb
##HCCI_RUN_NAME=por2
...
##RC_FREQUENCY=
##RCXDIR=/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/rcx_temp
##TEMPERATURE=27.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/por2.gnx,/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/por2.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/saul/projects/ASKA/PvsLVS/por2/svdb/por2
...
agds2rcx -V -H satfile -r \
	/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/por2.xcn \
	-split_float_exclude_layers ndiff,pdiff,nwtrm,bulk -crundir \
	/home/saul/projects/ASKA/PvsLVS/por2/svdb -unit meters -df2 -xgl -pl \
	por2.ports -f por2.alm -lnn por2.lnn -pnet 5 -pinst 6 -pdev 7 \
	por2.agf por2_pin_xy.spi
...
flattenLayers -m cont cont_m1trm_p1trm cont_p1trm_ndiff ntap
flattenLayers -m npdtap cont_m1trm_pdiff npdtap_ndiff_npdct ptap
flattenLayers -m via2CON cont_m1trm_ndiff npdct mosvcm
flattenLayers -m via1 cont_p1trm_pdiff npdtap_pdiff_npdct
...
reconnect -cgnd ${CAP_GROUND} -float floatlvsnetsfile -tf nem,pem -rf \
	rpp1k1_0s -df p_0dnw,p_0dnwm -gf BOX -probe \
...
connect -V -relocate NET np_rndiff:np_rndiff.conn np_rpdiff:np_rpdiff.conn \
	...
	np_rnpdct:np_rnpdct.conn rcont_m1trm_p1trm rvia1 rvia2CON nem_mgvia \
	pem_mgvia rpp1k1_0s_rvia mosvcm_p1trm_gdvia - npdtap_ndiff_npdct,1,5 \
	npdtap_pdiff_npdct,2,5 ntap,1,3 ptap,2,4 -
...
rex -V -m -pd -I'#' -tech \
	...
	rpp1k1_0s_rvia:mosvcm_p1trm_gdvia -rP res.mod np_rp1trm::POLY1_cut \
	...
	rvia2CON,3,4,t nem_mgvia,1,z pem_mgvia,1,z rpp1k1_0s_rvia,1,z \
	mosvcm_p1trm_gdvia,1,z - L1T0,2,I L2T0,3,I L3T0,4,I
...
reconnect -V -se2 bwires.res -n NET -b BOX:BOXr mosvcm \
	mosvcm_p1trm_gdvia,mosvcm_nwtrm_gdvia,mosvcm_bulk_gdvia
...
# /bin/rm -f g_dev_3
relocate -V -a -I relocatemap -n NET sub_in active_in POLY1_in
...
pax16 -V -lee_off -delete_unused_files rm_files_in_pax16 -gnd ${CAP_GROUND} \
	...
	MET2:MET2_cut MET3:MET3_cut MET4 METTP METTPL GateLayers - \
	/home/saul/pkg/xfab/XKIT/xh018/cadence/v9_0/QRC_pvs/v9_0_1/XH018_1143/QRC-Typ/qrcTechFile \
	- - NET - capfile
relocate -V -r maxnetfile -n NET sub active POLY1 rcont_m1trm_p1trm rvia1 \
	rvia2CON
...
xreduce -V -mergecap -n NET -tech \
	/home/saul/pkg/xfab/XKIT/xh018/cadence/v9_0/QRC_pvs/v9_0_1/XH018_1143/QRC-Typ \
	-d1 -e \
	METTPL,METTP,MET4,MET3,MET2,MET1,POLY1,active,sub,np_rndiff,np_rpdiff,np_rnwtrm,np_rbulk,rcont_m1trm_p1trm,rvia1,rvia2CON \
	...
	pem.transnr rpp1k1_0s.resr p_0dnw.dpaxr p_0dnwm.dpaxr BOXr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0 -dxref \
	/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/por2.gdx -nxref \
	/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/por2.gnx -addprefix \
	-sc caps2dversion -mx capfile \
	...
	lvsdio.mod1,p_0dnw.net p_0dnw.dpaxr -dM lvsdio.mod2,p_0dnwm.net \
	p_0dnwm.dpaxr - NET - \
	/home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/extview.tmp
...
mosvcm mosvcm
ENDCAT
cat /home/saul/projects/ASKA/PvsLVS/por2/svdb/por2/hccisavefile >> \
	_save_layers
