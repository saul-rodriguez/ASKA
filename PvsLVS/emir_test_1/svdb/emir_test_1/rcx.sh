...
# This script was generated Wed Jul 17 07:03:24 2024 by:
#
...
#	/home/saul/projects/ASKA/PvsLVS/emir_test_1/svdb/emir_test_1/extview.tmp \
#	-net_name_space layout -minR 1 -max_merged_via_size auto \
...
#	-extract_mos_diffusion_res -extract res -em_extract -df2 \
#	-device_finger_delimiter @ -cap_models yes -array_vias_spacing auto \
#	-analysis em -agds_layer_map_file \
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/saul/projects/ASKA/PvsLVS/emir_test_1/svdb/emir_test_1/extview.tmp
...
agds2rcx -V -H satfile -r \
	...
	/home/saul/projects/ASKA/PvsLVS/emir_test_1/svdb -unit meters -df2 \
	-xgl -pl emir_test_1.ports -f emir_test_1.alm -lnn emir_test_1.lnn \
	-pnet 5 -pinst 6 -pdev 7 emir_test_1.agf emir_test_1_pin_xy.spi
...
reconnect -V -se2 rwires.res -n NET -r rpp1k1_02.res:rpp1k1_02.resr rpp1k1_02 \
	rpp1k1_02_rvia
...
xreduce -V -mergecap -n NET -tech \
	/home/saul/pkg/xfab/XKIT/xh018/cadence/v9_0/QRC_pvs/v9_0_1/XH018_1143/QRC-Typ \
	-d1 -e np_rm1trm,np_rp1trm,np_rbulk,rcont_m1trm_p1trm -decoupled \
	-minR 1 -rP \
	np_rm1trm.res,np_rp1trm.res,rwires.res,rcont_m1trm_p1trm.res L1T0 \
	rpp1k1_02.resr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -dxref \
	/home/saul/projects/ASKA/PvsLVS/emir_test_1/svdb/emir_test_1/emir_test_1.gdx \
	-nxref \
	/home/saul/projects/ASKA/PvsLVS/emir_test_1/svdb/emir_test_1/emir_test_1.gnx \
	-addprefix -sc caps2dversion -rPmwl res.mod \
	np_rm1trm.res,Rnp_rm1trm.dev2 np_rp1trm.res,Rnp_rp1trm.dev2 \
	rcont_m1trm_p1trm.res,Rrcont_m1trm_p1trm.dev2 -rPmwl rwires.mod \
	rwires.res,rwires.dev2 -raM lvsres.mod,rpp1k1_02.net rpp1k1_02.resr - \
	NET - \
	/home/saul/projects/ASKA/PvsLVS/emir_test_1/svdb/emir_test_1/extview.tmp
...
cont np_rcont_m1trm_p1trm p_rcont_m1trm_p1trm
m1trm np_rm1trm p_rm1trm
p1trm np_rp1trm p_rp1trm
bulk np_rbulk p_rbulk
ENDCAT
cat /home/saul/projects/ASKA/PvsLVS/emir_test_1/svdb/emir_test_1/hccisavefile \
	>> _save_layers
